...
Here is the link to the [News Source](https://blockclubchicago.org/2021/11/15/man-charged-with-murder-in-killing-of-uchicago-graduate-in-hyde-park/).
...
datatable(head(show_data,20), rownames = FALSE, filter = "top", 
          options = list(pageLength = 5, scrollX = T, lengthMenu = c(5, 10, 15, 20))
